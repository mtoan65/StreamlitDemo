...
def train(model,
    ...
    for epoch in range(start_epoch + 1, end_epoch + 1):
        ...
        # eval testset
        test_loss_avg, test_metric_loss_avg, test_accuracy = eval(model, device, have_prj, testloader, metric_loss, miner, criterion, split='test')
